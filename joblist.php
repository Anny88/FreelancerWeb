  ...
  <div class="container main" align="center">
    ...
    <div class = "col-sm-12 desc">
        ...
        <div id = "hid" style="display:none">
            ...
            <div class="col-sm-6 col-md-2 text-left" style="display:inline-block;margin:0px; padding-left:-1px;">
                <h4>Payment:</h4>  
                <p class = "noline">150$</p>
            </div>
            <div class= "col-sm-6 col-md-2 text-left" style="display:inline-block; margin:0;">
                <h4>Deadline:</h4>  
...
<div class="container mrg">
  <div class="container main" align="center">
    ...
    <div class = "col-sm-12 desc">
        ...
        <div class="col-sm-12 col-md-6 col-sm-offset-0" style="display:inline-block;">
          <h4 style = "margin-top: 1%;">Description:</h4>
